...
export default function LegalPage(){
  return <main className="legalPage">
    ...
    <section aria-label="Usage analytics"><h3>Usage analytics</h3><p>When enabled, Vercel Web Analytics measures visits to our public pages and counts AI submissions, responses, and failures by Homeowner or Pro mode. Our custom events do not include questions, answers, customer details, photos, filenames, or source fingerprints. We remove query strings and URL fragments from tracked page URLs. Vercel processes technical visit information to produce traffic statistics. Analytics is separate from the information sent to the AI provider when you ask a question.</p></section>
