...
const FINDING_STATUSES=["satisfactory","monitor","observation_noted","maintenance_recommended","repair_recommended","further_evaluation_recommended","unable_to_inspect","not_applicable"] as const;
