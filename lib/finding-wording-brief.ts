...
Use original_saved_note as the ONLY source of report assertions. The selected status is supplied solely to detect contradictions, not as additional report content. Do not translate a status such as further_evaluation_recommended or repair_recommended into a recommendation sentence unless that recommendation is explicitly in original_saved_note.
